...
contract CertoraStakingRewardIndexNonDecreasingClean {
    ...
    function setRewardIndex(uint256 newIndex) external {
        require(newIndex >= rewardPerTokenStored, "reward index regression");
