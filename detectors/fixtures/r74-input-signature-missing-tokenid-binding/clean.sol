...
contract VeGovernorClean is EIP712Base {
    bytes32 internal constant VOTE_TYPEHASH =
        keccak256("Vote(uint256 tokenId,address voter,uint256 proposalId,uint8 support,uint256 nonce,uint256 deadline)");
    ...
    function castVoteBySig(
        ...
        bytes32 structHash = keccak256(
            abi.encode(VOTE_TYPEHASH, tokenId, voter, proposalId, support, nonce, deadline)
        );
