...
interface IStakingRewardsZeroVaultClean {
    struct PoolInfo {
...
contract MissingZeroCheckOnVaultAddressDepositAndStakeClean {
    ...
    function depositAndStake(
        ...
        require(vaultAddress != address(0), "zero vault");
        require(
            IStakingRewardsZeroVaultClean(stakingRewards).getPool(poolId).stakingToken == vaultAddress,
            "Incorrect pool id"
        );
