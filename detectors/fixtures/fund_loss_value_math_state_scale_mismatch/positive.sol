...
contract StaleRateStateScaleMismatchPositive {
...
contract QueuedAssetStateScaleMismatchPositive {
...
contract FeeStateScaleMismatchPositive {
    ...
    function collectFee(address feeRecipient) external {
