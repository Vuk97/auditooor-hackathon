...
library EnumerableBytes32SetVuln {
    struct Bytes32Set {
        bytes32[] _values;
...
contract Bytes32CachedLengthRemoveVuln {
    using EnumerableBytes32SetVuln for EnumerableBytes32SetVuln.Bytes32Set;

    EnumerableBytes32SetVuln.Bytes32Set private tags;
    ...
    function prune() external {
        uint256 cachedLength = tags.length();
