...
contract MarketplaceAuthorityClaimWithoutOriginProofClean {
    struct ListingInput {
        uint256 assetId;
        address seller;
        uint256 price;
    ...
    function createListing(
        ...
        address sellerSigner = ECDSA.recover(_hashListing(listing), sellerSig);
        require(sellerSigner == listing.seller, "bad seller");
