...
contract OverrideAppliedButAccountingUsesOriginalStateClean {
    ...
    function overrideCampaignAndFinalize(
        ...
        CampaignState memory activeCampaign = campaigns[campaignId];
        remaining =
            activeCampaign.budget -
            (activeCampaign.spent * activeCampaign.rate);
    }
}
