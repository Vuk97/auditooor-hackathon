...
contract OptionsUncappedPositionCountMakesAccountUnliquidatableClean {
    uint256 internal constant MAX_POSITIONS_PER_ACCOUNT = 32;
    ...
    function mintOptions(uint256 tokenId, uint256 size) external {
        ...
        require(positionIdList[msg.sender].length < MAX_POSITIONS_PER_ACCOUNT, "too many positions");
