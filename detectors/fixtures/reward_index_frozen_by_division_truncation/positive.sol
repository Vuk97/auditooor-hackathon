...
interface IRewardIndexSupplyPositive {
    function totalSupply() external view returns (uint256);
}

contract LoopFiRewardManagerPositive {
    IRewardIndexSupplyPositive public immutable shares;
    uint256 public rewardIndex;
    uint256 public lastRewardBalance;

    constructor(IRewardIndexSupplyPositive shares_) {
        shares = shares_;
    }
