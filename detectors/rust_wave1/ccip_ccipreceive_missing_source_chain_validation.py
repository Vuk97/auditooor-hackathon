"""
ccip_ccipreceive_missing_source_chain_validation

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: ccip-ccipreceive-missing-source-chain-validation
Platform: solana
Source: phase7_rust_fixture_ccip_ccipreceive_missing_source_chain_validation.json
...
_INDICATOR_PATTERNS = ['fn\\s+_?ccip_?[Rr]eceive\\s*\\(', 'Any2EVMMessage', 'source_chain_selector']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    if re.search(r"allowed_source_chains\.contains\s*\(\s*&message\.source_chain_selector\s*\)", code):
        return hits
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'ccip_ccipreceive_missing_source_chain_validation' detected "
