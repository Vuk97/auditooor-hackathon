"""
council_veto_protection_does_not_work_selector_check_bypass

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: council-veto-protection-does-not-work-selector-check-bypass
Platform: solana
Source: phase7_rust_fixture_council_veto_protection_does_not_work_selector_check_bypass.json
...
_INDICATOR_PATTERNS = ['calldata\\[0\\.\\.4\\]', 'calldata\\.len\\(\\)\\s*>=\\s*4', 'selector\\s*==\\s*CHANGE_COUNCIL', 'action\\.calldata\\[0\\.\\.4\\]']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    if "contains_change_council_recursive" in code and "calldata.windows(4)" in code:
        return hits
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'council_veto_protection_does_not_work_selector_check_bypass' detected "
