"""
uniswap_swap_without_slippage_or_deadline

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: uniswap-swap-without-slippage-or-deadline
Platform: solana
Source: phase7_rust_fixture_uniswap_swap_without_slippage_or_deadline.json
...
_INDICATOR_PATTERNS = ['deadline:\\s*U256::MAX', 'amount_out_minimum:\\s*U256::ZERO', 'exactInputSingle.*deadline.*=.*type\\(uint256\\)\\.max', 'amountOutMinimum\\s*=\\s*0']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'uniswap_swap_without_slippage_or_deadline' detected "
