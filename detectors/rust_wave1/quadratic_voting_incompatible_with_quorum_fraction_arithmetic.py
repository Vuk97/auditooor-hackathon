"""
quadratic_voting_incompatible_with_quorum_fraction_arithmetic

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: quadratic-voting-incompatible-with-quorum-fraction-arithmetic
Platform: solana
Source: phase7_rust_fixture_quadratic_voting_incompatible_with_quorum_fraction_arithmetic.json
...
_INDICATOR_PATTERNS = ['quorum.*total_supply|totalSupply.*quorum', 'sqrt.*vote|vote.*sqrt|quadratic.*vote|integer_sqrt', 'quorum_numerator.*quorum_denominator|quorum.*fraction']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'quadratic_voting_incompatible_with_quorum_fraction_arithmetic' detected "
