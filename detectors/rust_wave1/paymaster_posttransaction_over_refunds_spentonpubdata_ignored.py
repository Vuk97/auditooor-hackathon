"""
paymaster_posttransaction_over_refunds_spentonpubdata_ignored

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: paymaster-posttransaction-over-refunds-spentonpubdata-ignored
Platform: solana
Source: phase7_rust_fixture_paymaster_posttransaction_over_refunds_spentonpubdata_ignored.json
...
_INDICATOR_PATTERNS = ['post_transaction.*max_refunded_gas|postTransaction.*_maxRefundedGas', 'min\\s*\\([^)]*max_refunded|min\\s*\\([^)]*_maxRefundedGas']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    if re.search(r"max_refunded_gas\.saturating_sub\s*\(\s*tx_result\.spent_on_pubdata\s*\)", code):
        return hits
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'paymaster_posttransaction_over_refunds_spentonpubdata_ignored' detected "
