"""
deposit_fixed_doesn_t_validate_tick_range_against_vault_tick_range

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: deposit-fixed-doesn-t-validate-tick-range-against-vault-tick-range
Platform: solana
Source: phase7_rust_fixture_deposit_fixed_doesn_t_validate_tick_range_against_vault_tick_range.json
...
_INDICATOR_PATTERNS = ['fn\\s+deposit_fixed\\s*\\(', 'tick_lower\\s*:\\s*i32', 'tick_upper\\s*:\\s*i32', '\\.get\\s*\\(\\s*&vault_id\\s*\\)']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    if re.search(
        r"tick_lower\s*!=\s*vault\.tick_range\.tick_lower\s*\|\|\s*"
        r"tick_upper\s*!=\s*vault\.tick_range\.tick_upper",
        code,
    ):
        return hits
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'deposit_fixed_doesn_t_validate_tick_range_against_vault_tick_range' detected "
