"""
linear_bonding_curve_pricing_miscalc

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: linear-bonding-curve-pricing-miscalc
Platform: solana
Source: phase7_rust_fixture_linear_bonding_curve_pricing_miscalc.json
...
_INDICATOR_PATTERNS = ['price\\s*\\*\\s*n', 'base\\s*\\+\\s*delta\\s*\\*\\s*n\\s*\\*\\s*n', '\\(base\\s*\\+\\s*delta\\s*\\*\\s*n\\)\\s*\\*\\s*n']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'linear_bonding_curve_pricing_miscalc' detected "
