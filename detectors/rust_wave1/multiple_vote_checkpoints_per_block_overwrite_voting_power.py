"""
multiple_vote_checkpoints_per_block_overwrite_voting_power

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: multiple-vote-checkpoints-per-block-overwrite-voting-power
Platform: solana
Source: phase7_rust_fixture_multiple_vote_checkpoints_per_block_overwrite_voting_power.json
...
_INDICATOR_PATTERNS = ['checkpoints\\.push\\s*\\(', 'checkpoint_history\\.push\\s*\\(', 'binary_search.*checkpoint', 'checkpoints\\s*:\\s*Vec\\s*<']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'multiple_vote_checkpoints_per_block_overwrite_voting_power' detected "
