"""
dutch_auction_stores_phantom_bid_locks_honest_escrow

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: dutch-auction-stores-phantom-bid-locks-honest-escrow
Platform: solana
Source: phase7_rust_fixture_dutch_auction_stores_phantom_bid_locks_honest_escrow.json
...
_INDICATOR_PATTERNS = ['_bid_for_auction', 'best_bid_for_listing.*insert', 'bid.*auction.*push.*best.*bid']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'dutch_auction_stores_phantom_bid_locks_honest_escrow' detected "
