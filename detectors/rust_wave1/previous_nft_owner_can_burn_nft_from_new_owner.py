"""
previous_nft_owner_can_burn_nft_from_new_owner

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: previous-nft-owner-can-burn-nft-from-new-owner
Platform: solana
Source: phase7_rust_fixture_previous_nft_owner_can_burn_nft_from_new_owner.json
...
_INDICATOR_PATTERNS = ['owner_to_record\\s*\\.\\s*get\\s*\\(\\s*&\\s*caller', '\\.get\\s*\\(\\s*&\\s*\\w+\\s*\\).*burn', 'transfer.*owner.*=.*new_owner\\n(?![\\s\\S]{0,200}owner_to_record\\s*\\.\\s*(remove|insert))']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'previous_nft_owner_can_burn_nft_from_new_owner' detected "
