"""
anyone_takes_a_loan_on_behalf_of_any_collateral_holder

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: anyone-takes-a-loan-on-behalf-of-any-collateral-holder
Platform: solana
Source: phase7_rust_fixture_anyone_takes_a_loan_on_behalf_of_any_collateral_holder.json
...
_INDICATOR_PATTERNS = ['validate.*commitment', 'caller.*borrower.*collateral_owner', 'check.*caller.*receiver']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'anyone_takes_a_loan_on_behalf_of_any_collateral_holder' detected "
