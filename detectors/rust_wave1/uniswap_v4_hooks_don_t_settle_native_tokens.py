"""
uniswap_v4_hooks_don_t_settle_native_tokens

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: uniswap-v4-hooks-don-t-settle-native-tokens
Platform: solana
Source: phase7_rust_fixture_uniswap_v4_hooks_don_t_settle_native_tokens.json
...
_INDICATOR_PATTERNS = ['settle.*\\{[^}]*transfer_from', 'settle.*\\{[^}]*safe_transfer', 'if.*native.*\\{[^}]*transfer_from', 'if.*native.*\\{[^}]*safe_transfer']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'uniswap_v4_hooks_don_t_settle_native_tokens' detected "
