"""
mtoft_rebalancing_steals_eth_sgreceive_not_called

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: mtoft-rebalancing-steals-eth-sgreceive-not-called
Platform: solana
Source: phase7_rust_fixture_mtoft_rebalancing_steals_eth_sgreceive_not_called.json
...
_INDICATOR_PATTERNS = ['rebalance.*remote|rebalance_to', 'native_balance.*\\+\\=|\\.transfer\\(|\\.send\\(', 'sg_receive|sgReceive']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    if re.search(r"fn\s+rebalance_to_remote\b[\s\S]*?dst_mtoft\.sg_receive\s*\(", code):
        return hits
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'mtoft_rebalancing_steals_eth_sgreceive_not_called' detected "
