"""
users_lose_collateral_when_exiting_a_short_position

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: users-lose-collateral-when-exiting-a-short-position
Platform: solana
Source: phase7_rust_fixture_users_lose_collateral_when_exiting_a_short_position.json
...
_INDICATOR_PATTERNS = ['exit_[Ss]hort.*\\{[^}]*remove\\s*\\(', 'close_[Ss]hort.*\\{[^}]*remove\\s*\\(', 'collateral.*not.*return', 'sr\\.collateral.*drop']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'users_lose_collateral_when_exiting_a_short_position' detected "
