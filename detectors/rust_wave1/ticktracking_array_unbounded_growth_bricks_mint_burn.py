"""
ticktracking_array_unbounded_growth_bricks_mint_burn

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: ticktracking-array-unbounded-growth-bricks-mint-burn
Platform: solana
Source: phase7_rust_fixture_ticktracking_array_unbounded_growth_bricks_mint_burn.json
...
_INDICATOR_PATTERNS = ['tick_?tracking\\s*:\\s*Vec<', '\\.push\\s*\\(\\s*TickEntry', 'for\\s+\\w+\\s+in\\s+&\\s*tick_?tracking', 'update_?tick_?tracking.*push\\(']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'ticktracking_array_unbounded_growth_bricks_mint_burn' detected "
