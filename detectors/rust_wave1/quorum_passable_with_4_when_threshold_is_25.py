"""
quorum_passable_with_4_when_threshold_is_25

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: quorum-passable-with-4-when-threshold-is-25
Platform: solana
Source: phase7_rust_fixture_quorum_passable_with_4_when_threshold_is_25.json
...
_INDICATOR_PATTERNS = ['quorum.*for_votes.*against_votes.*abstain_votes', 'quorum.*total_cast_votes', 'for_votes\\s*\\+\\s*against_votes\\s*\\+\\s*abstain_votes', 'quorum.*checked_add.*checked_add']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'quorum_passable_with_4_when_threshold_is_25' detected "
