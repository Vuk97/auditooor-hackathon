...
const BEEFY_VALIDATOR_SET_DOMAIN_FIRE39: &[u8] = b"beefy-validator-set-domain-fire39";
...
impl BeefyBridgeClient {
    pub fn submit_beefy_validator_set_update(
        ...
        transcript.extend_from_slice(BEEFY_VALIDATOR_SET_DOMAIN_FIRE39);
        ...
        transcript.extend_from_slice(&current_set.id.to_be_bytes());
        transcript.extend_from_slice(&current_set.root);
        transcript.extend_from_slice(&current_set.len.to_be_bytes());
        transcript.extend_from_slice(&next_set.id.to_be_bytes());
        transcript.extend_from_slice(&next_set.root);
        transcript.extend_from_slice(&next_set.len.to_be_bytes());
