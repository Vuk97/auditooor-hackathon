...
impl RewardsVault {
    pub fn transfer_orphans_accrued_rewards(&mut self, from: u64, to: u64, amount: u128) {
    ...
    pub fn allocate_vault_rewards_timing_theft(&mut self, vault_id: u64, allocation: u128) {
    ...
    pub fn write_vote_checkpoint_without_reward_sync(
        &mut self,
        delegatee: u64,
        weight: u128,
        epoch: u64,
