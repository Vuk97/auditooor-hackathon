...
impl PermitVault {
    pub fn execute_signed_permit_claim(
        ...
        sign_bytes.extend_from_slice(&self.chain_id.to_be_bytes());
        sign_bytes.extend_from_slice(&self.domain_separator);
        sign_bytes.extend_from_slice(&self.contract_id);
        sign_bytes.extend_from_slice(&owner_account);
        sign_bytes.extend_from_slice(&nonce.to_be_bytes());
        sign_bytes.push(purpose);
