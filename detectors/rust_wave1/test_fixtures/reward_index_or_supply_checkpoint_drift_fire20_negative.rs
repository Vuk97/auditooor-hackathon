...
fn update_reward(_user: Address) {}
fn checkpoint_user_rewards(_user: Address) {}
...
fn transfer_leftover_to_user(_amount: u64) {}
...
impl RewardPool {
    ...
    pub fn complete_queued_withdrawal(amount: u64) {
        ...
        let to_fill = buffer_space.min(amount);
