...
impl BridgeExecutor {
    pub fn execute_signed_bridge_calldata(
        ...
        digest_input.extend_from_slice(&packet.source_chain_id.to_be_bytes());
        digest_input.extend_from_slice(&packet.destination_chain_id.to_be_bytes());
        digest_input.extend_from_slice(&packet.endpoint_id.to_be_bytes());
        digest_input.extend_from_slice(&packet.message_nonce.to_be_bytes());
