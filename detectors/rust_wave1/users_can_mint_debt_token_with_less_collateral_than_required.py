"""
users_can_mint_debt_token_with_less_collateral_than_required

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: users-can-mint-debt-token-with-less-collateral-than-required
Platform: solana
Source: phase7_rust_fixture_users_can_mint_debt_token_with_less_collateral_than_required.json
...
_INDICATOR_PATTERNS = ['if.*[Ss]tatus.*==.*[Cc]losed.*\\{[^}]*remove', 'cancel.*[Oo]rder.*[Cc]losed.*remove', 'SR\\.Closed.*remove']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'users_can_mint_debt_token_with_less_collateral_than_required' detected "
