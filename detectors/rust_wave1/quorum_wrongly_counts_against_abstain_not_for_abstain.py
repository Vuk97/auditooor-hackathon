"""
quorum_wrongly_counts_against_abstain_not_for_abstain

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: quorum-wrongly-counts-against-abstain-not-for-abstain
Platform: solana
Source: phase7_rust_fixture_quorum_wrongly_counts_against_abstain_not_for_abstain.json
...
_INDICATOR_PATTERNS = ['against_votes\\s*\\+\\s*abstain_votes.*>=.*quorum', 'quorum.*against.*\\+.*abstain']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'quorum_wrongly_counts_against_abstain_not_for_abstain' detected "
