"""
unsafe_u256_u128_cast_can_silently_truncate

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: unsafe-u256-u128-cast-can-silently-truncate
Platform: solana
Source: phase7_rust_fixture_unsafe_u256_u128_cast_can_silently_truncate.json
...
_INDICATOR_PATTERNS = ['to_le_bytes::<32>\\(\\)', 'to_be_bytes::<32>\\(\\)', 'copy_from_slice\\(&.*\\[\\.\\.16\\]\\)', 'u128::from_le_bytes\\(\\[', 'from_be_bytes\\(\\[']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    if re.search(r"value\s*>\s*U256::from\s*\(\s*u128::MAX\s*\)", code):
        return hits
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'unsafe_u256_u128_cast_can_silently_truncate' detected "
