"""
swap_amountspecified_not_updated_after_price_clamp_locks_funds

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: swap-amountspecified-not-updated-after-price-clamp-locks-funds
Platform: solana
Source: phase7_rust_fixture_swap_amountspecified_not_updated_after_price_clamp_locks_funds.json
...
_INDICATOR_PATTERNS = ['clamp.*price.*amount_specified.*not.*update', 'sqrt_price.*min.*max.*amount_specified_remaining', 'price.*bound.*amount.*lock', 'amountSpecified.*clamp.*funds']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'swap_amountspecified_not_updated_after_price_clamp_locks_funds' detected "
