"""
slippage_memory_var_not_propagated_unlimited_slippage

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: slippage-memory-var-not-propagated-unlimited-slippage
Platform: solana
Source: phase7_rust_fixture_slippage_memory_var_not_propagated_unlimited_slippage.json
...
_INDICATOR_PATTERNS = ['let\\s+slippage\\s*:\\s*\\w+', 'amount_out_min\\s*:\\s*U256::ZERO', 'slippage_bps']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'slippage_memory_var_not_propagated_unlimited_slippage' detected "
