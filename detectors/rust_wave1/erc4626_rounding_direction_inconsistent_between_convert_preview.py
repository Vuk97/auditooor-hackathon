"""
erc4626_rounding_direction_inconsistent_between_convert_preview

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: erc4626-rounding-direction-inconsistent-between-convert-preview
Platform: solana
Source: phase7_rust_fixture_erc4626_rounding_direction_inconsistent_between_convert_preview.json
...
_INDICATOR_PATTERNS = ['preview_deposit.*saturating_sub.*checked_add', 'preview_mint.*saturating_sub.*checked_add', 'ceil.*preview.*convert.*floor', 'convert_to_shares.*floor.*preview.*ceil']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'erc4626_rounding_direction_inconsistent_between_convert_preview' detected "
