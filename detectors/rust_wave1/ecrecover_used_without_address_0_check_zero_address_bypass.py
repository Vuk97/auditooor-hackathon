"""
ecrecover_used_without_address_0_check_zero_address_bypass

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: ecrecover-used-without-address-0-check-zero-address-bypass
Platform: solana
Source: phase7_rust_fixture_ecrecover_used_without_address_0_check_zero_address_bypass.json
...
_INDICATOR_PATTERNS = ['ecrecover\\s*\\(', 'recover_signer\\s*\\(', '\\.recover\\s*\\(', 'Address::ZERO', 'address\\(0\\)', 'signer.*==.*Address::ZERO', '!=.*Address::ZERO']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'ecrecover_used_without_address_0_check_zero_address_bypass' detected "
