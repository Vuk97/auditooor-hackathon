"""
shared_uniswap_tick_range_steals_another_pair_s_liquidity

Auto-generated from r94 phase7 overnight pipeline.
Pattern class: shared-uniswap-tick-range-steals-another-pair-s-liquidity
Platform: solana
Source: phase7_rust_fixture_shared_uniswap_tick_range_steals_another_pair_s_liquidity.json
...
_INDICATOR_PATTERNS = ['\\.burn\\s*\\(\\s*[^,]+,\\s*[^,]+,\\s*[^)]+\\)', 'reallocate.*burn.*tick_lower.*tick_upper', 'HashMap<\\s*\\(\\s*i32\\s*,\\s*i32\\s*\\)\\s*,\\s*u128\\s*']
...
def run(tree, source: bytes, filepath: str):  # noqa: ARG001
    ...
    hits.append({
        ...
        "message": (
            f"{filepath}: pattern 'shared_uniswap_tick_range_steals_another_pair_s_liquidity' detected "
