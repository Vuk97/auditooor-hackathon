"""Smoke regression for pause-blocks-repay-and-liquidation."""
...
DETECTOR = "pause-blocks-repay-and-liquidation"
...
class PauseBlocksRepayAndLiquidationSmokeTest(unittest.TestCase):
    def test_vuln_fixture_hits_and_clean_fixture_does_not(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="pause_blocks_repay_") as tmp:
            scratch = Path(tmp)
