...
PATTERN = "ecdsa-low-s-missing"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "ecdsa_low_s_missing"
...
class EcdsaLowSMissingTest(unittest.TestCase):
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn("vuln: detectors/fixtures/ecdsa_low_s_missing/positive.sol", text)
        self.assertIn("clean: detectors/fixtures/ecdsa_low_s_missing/clean.sol", text)
