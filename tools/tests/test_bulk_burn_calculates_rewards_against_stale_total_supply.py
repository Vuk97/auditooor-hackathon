...
PATTERN = "bulk-burn-calculates-rewards-against-stale-total-supply"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
DETECTOR = ROOT / "detectors" / "wave17" / "bulk_burn_calculates_rewards_against_stale_total_supply.py"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "bulk_burn_calculates_rewards_against_stale_total_supply"
...
class BulkBurnCalculatesRewardsAgainstStaleTotalSupplyTest(unittest.TestCase):
    ...
    def test_pattern_compile_round_trip_matches_generated_detector(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            prefix=".pattern_compile_bulk_burn_stale_supply_",
            dir=ROOT,
        ) as tmp:
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/bulk_burn_calculates_rewards_against_stale_total_supply/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/bulk_burn_calculates_rewards_against_stale_total_supply/clean.sol",
            text,
        )
