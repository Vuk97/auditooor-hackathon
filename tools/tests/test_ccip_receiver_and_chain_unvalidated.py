...
PATTERN = "ccip-receiver-and-chain-unvalidated"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "ccip_receiver_and_chain_unvalidated"
...
class CcipReceiverAndChainUnvalidatedTest(unittest.TestCase):
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/ccip_receiver_and_chain_unvalidated/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/ccip_receiver_and_chain_unvalidated/clean.sol",
            text,
        )
