...
PATTERN = "callback-reentrancy-no-guard-dsl"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "callback_reentrancy_no_guard_dsl"
...
class CallbackReentrancyNoGuardDslTest(unittest.TestCase):
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/callback_reentrancy_no_guard_dsl/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/callback_reentrancy_no_guard_dsl/clean.sol",
            text,
        )
