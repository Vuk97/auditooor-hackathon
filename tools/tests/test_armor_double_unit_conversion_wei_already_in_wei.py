...
PATTERN = "armor-double-unit-conversion-wei-already-in-wei"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
DETECTOR = ROOT / "detectors" / "wave17" / "armor_double_unit_conversion_wei_already_in_wei.py"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "armor_double_unit_conversion_wei_already_in_wei"
...
class ArmorDoubleUnitConversionWeiAlreadyInWeiTest(unittest.TestCase):
    ...
    def test_pattern_compile_round_trip_matches_generated_detector(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            prefix=".pattern_compile_armor_double_unit_",
            dir=ROOT,
        ) as tmp:
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/armor_double_unit_conversion_wei_already_in_wei/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/armor_double_unit_conversion_wei_already_in_wei/clean.sol",
            text,
        )
