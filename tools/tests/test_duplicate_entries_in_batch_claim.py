...
PATTERN = "duplicate-entries-in-batch-claim"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "duplicate_entries_in_batch_claim"
...
class DuplicateEntriesInBatchClaimTest(unittest.TestCase):
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/duplicate_entries_in_batch_claim/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/duplicate_entries_in_batch_claim/clean.sol",
            text,
        )
