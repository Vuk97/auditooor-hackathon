...
PATTERN = "certora-makerdao-urn-art-ink-bounds"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
DETECTOR = ROOT / "detectors" / "wave17" / "certora_makerdao_urn_art_ink_bounds.py"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "certora_makerdao_urn_art_ink_bounds"
...
class CertoraMakerdaoUrnArtInkBoundsTest(unittest.TestCase):
    ...
    def test_pattern_compile_round_trip_matches_generated_detector(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            prefix=".pattern_compile_certora_makerdao_urn_bounds_",
            dir=ROOT,
        ) as tmp:
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/certora_makerdao_urn_art_ink_bounds/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/certora_makerdao_urn_art_ink_bounds/clean.sol",
            text,
        )
