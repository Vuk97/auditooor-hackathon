...
PATTERN = "beneficiary-vesting-dust-deposit-relocks-unlock-dos"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
DETECTOR = ROOT / "detectors" / "wave17" / "beneficiary_vesting_dust_deposit_relocks_unlock_dos.py"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "beneficiary_vesting_dust_deposit_relocks_unlock_dos"
...
class BeneficiaryVestingDustDepositRelocksUnlockDosCapabilityTest(unittest.TestCase):
    ...
    def test_pattern_compile_round_trip_matches_generated_detector(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            prefix=".pattern_compile_beneficiary_vesting_dust_",
            dir=ROOT,
        ) as tmp:
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/beneficiary_vesting_dust_deposit_relocks_unlock_dos/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/beneficiary_vesting_dust_deposit_relocks_unlock_dos/clean.sol",
            text,
        )
