"""Smoke regression for blacklist-bypass-transferfrom."""
...
DETECTOR = "blacklist-bypass-transferfrom"
...
class BlacklistBypassTransferfromSmokeTest(unittest.TestCase):
    def test_vuln_fixture_hits_and_clean_fixture_does_not(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="blacklist_bypass_transferfrom_") as tmp:
            scratch = Path(tmp)
