...
PATTERN = "aave-v3-flashloan-callback-executeoperation-lacks-sender-validation"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
DETECTOR = ROOT / "detectors" / "wave17" / "aave_v3_flashloan_callback_executeoperation_lacks_sender_validation.py"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "aave_v3_flashloan_callback_executeoperation_lacks_sender_validation"
...
class AaveV3FlashloanCallbackExecuteoperationLacksSenderValidationTest(unittest.TestCase):
    ...
    def test_pattern_compile_round_trip_matches_generated_detector(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            prefix=".pattern_compile_aave_v3_flashloan_sender_",
            dir=ROOT,
        ) as tmp:
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/aave_v3_flashloan_callback_executeoperation_lacks_sender_validation/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/aave_v3_flashloan_callback_executeoperation_lacks_sender_validation/clean.sol",
            text,
        )
