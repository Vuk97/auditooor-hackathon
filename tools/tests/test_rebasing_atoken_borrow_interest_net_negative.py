...
PATTERN = "rebasing-atoken-borrow-interest-net-negative"
DETECTOR = ROOT / "detectors" / "wave17" / "rebasing_atoken_borrow_interest_net_negative.py"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "rebasing_atoken_borrow_interest_net_negative"
...
class RebasingAtokenBorrowInterestNetNegativeTest(unittest.TestCase):
    ...
    def test_detector_compiles_and_reference_points_to_fixtures(self) -> None:
