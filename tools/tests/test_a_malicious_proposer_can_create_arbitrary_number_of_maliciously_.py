...
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "a_malicious_proposer_can_create_arbitrary_number_of_maliciously"
PATTERN = "a-malicious-proposer-can-create-arbitrary-number-of-maliciously-"
SMOKE = FIXTURE_DIR / "ssi-fix-028_smoke.json"
...
class MaliciousProposalCountSmokeTests(unittest.TestCase):
    ...
    def test_positive_fixture_fires_and_clean_fixture_stays_quiet(self) -> None:
        self.assertGreaterEqual(self._hits("ssi-fix-028_positive.sol"), 1)
        self.assertEqual(self._hits("ssi-fix-028_clean.sol"), 0)
