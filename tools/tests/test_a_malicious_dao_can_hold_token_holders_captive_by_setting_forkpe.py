...
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "a_malicious_dao_can_hold_token_holders_captive_by_setting_forkpe"
PATTERN = "a-malicious-dao-can-hold-token-holders-captive-by-setting-forkpe"
SMOKE = FIXTURE_DIR / "ssi-fix-019_smoke.json"
...
class MaliciousDaoForkPeriodSmokeTests(unittest.TestCase):
    ...
    def test_positive_fixture_fires_and_clean_fixture_stays_quiet(self) -> None:
        self.assertGreaterEqual(self._hits("ssi-fix-019_positive.sol"), 1)
        self.assertEqual(self._hits("ssi-fix-019_clean.sol"), 0)
