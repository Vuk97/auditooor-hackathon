"""Smoke regression for repayloan-frontrun-liquidation."""
...
DETECTOR = "repayloan-frontrun-liquidation"
...
class RepayloanFrontrunLiquidationSmokeTest(unittest.TestCase):
    def test_vuln_fixture_hits_and_clean_fixture_does_not(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="repayloan_frontrun_") as tmp:
            scratch = Path(tmp)
