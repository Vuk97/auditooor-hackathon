...
PATTERN = "in-stable2lut1-getratiosfrompriceliquidity-in-extreme-cases-x"
DETECTOR = (
    ROOT
    / "detectors"
    / "wave_graveyard"
    / "syntax_broken"
    / "in_stable2lut1_getratiosfrompriceliquidity_in_extreme_cases__x.py"
)
...
FIXTURE_DIR = (
    ...
    / "detectors"
    / "fixtures"
    / "in_stable2lut1_getratiosfrompriceliquidity_in_extreme_cases_x"
)
...
class InStable2lut1GetratiosfrompriceliquidityInExtremeCasesXTest(unittest.TestCase):
    def _hits(self, fixture: Path) -> int:
        ...
        script = textwrap.dedent(
            ...
            spec = importlib.util.spec_from_file_location("stable2lut1_row_detector", detector_path)
            ...
            for compilation_unit in slither.compilation_units:
                detector = module.InStable2lut1GetratiosfrompriceliquidityInExtremeCasesX(
                    compilation_unit,
                    slither,
                    logger,
                )
