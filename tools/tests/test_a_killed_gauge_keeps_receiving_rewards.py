"""Smoke regression for a-killed-gauge-keeps-receiving-rewards."""
...
DETECTOR = "a-killed-gauge-keeps-receiving-rewards"
FIXTURE_DIR = REPO / "detectors" / "fixtures" / "a_killed_gauge_keeps_receiving_rewards"
FIXTURE_VULN = FIXTURE_DIR / "ssi-fix-014_positive.sol"
FIXTURE_CLEAN = FIXTURE_DIR / "ssi-fix-014_clean.sol"
...
class AKilledGaugeKeepsReceivingRewardsSmokeTest(unittest.TestCase):
    def test_vuln_fixture_hits_and_clean_fixture_does_not(self) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="a_killed_gauge_rewards_") as tmp:
            scratch = Path(tmp)
