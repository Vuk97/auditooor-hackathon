...
PATTERN = "inconsistent-decimal-handling-across-codebase"
DETECTOR = (
    ROOT
    / "detectors"
    / "wave_graveyard"
    / "syntax_broken"
    / "inconsistent_decimal_handling_across_codebase.py"
)
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "inconsistent_decimal_handling_across_codebase"
...
class InconsistentDecimalHandlingAcrossCodebaseTest(unittest.TestCase):
    def _hits(self, fixture: Path) -> int:
        ...
        script = textwrap.dedent(
            ...
            spec = importlib.util.spec_from_file_location("inconsistent_decimal_row_detector", detector_path)
            ...
            for compilation_unit in slither.compilation_units:
                detector = module.InconsistentDecimalHandlingAcrossCodebase(
                    compilation_unit,
                    slither,
                    logger,
                )
