...
PATTERN = "r94-reverse-flashloan-premium-rounded-down"
DETECTOR = ROOT / "detectors" / "wave17" / "r94_reverse_flashloan_premium_rounded_down.py"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "r94_reverse_flashloan_premium_rounded_down"
MIRROR_DIR = ROOT / "detectors" / "fixtures" / "r94-reverse-flashloan-premium-rounded-down"
...
class R94ReverseFlashloanPremiumRoundedDownTest(unittest.TestCase):
    ...
    def test_reference_yaml_and_smoke_metadata_stay_aligned(self) -> None:
        ...
        self.assertIn("flashLoan", detector_text)
        self.assertIn("premium = amount * premiumBps / 10000", positive_text)
        self.assertIn("denominator = 10000", clean_text)
        self.assertIn("premium = (amount * premiumBps + denominator - 1) / denominator", clean_text)
        ...
        self.assertEqual(mirror_payload["fixture_id"], "r94-reverse-flashloan-premium-rounded-down")
