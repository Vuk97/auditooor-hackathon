...
DETECTOR_ID = "rust_rewards_transfer_orphans_accrual_fire29"
...
class RustRewardsTransferOrphansAccrualFire29Tests(unittest.TestCase):
    ...
    def test_positive_fixture_fires(self) -> None:
        ...
        self.assertIn("orphan accrued rewards", log_text)
