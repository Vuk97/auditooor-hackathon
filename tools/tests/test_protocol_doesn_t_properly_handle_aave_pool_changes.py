...
PATTERN = "protocol-doesn-t-properly-handle-aave-pool-changes"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "protocol_doesn_t_properly_handle_aave_pool_changes"
MIRROR_DIR = ROOT / "detectors" / "fixtures" / "protocol-doesn-t-properly-handle-aave-pool-changes"
...
class ProtocolDoesntProperlyHandleAavePoolChangesTest(unittest.TestCase):
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/protocol_doesn_t_properly_handle_aave_pool_changes/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/protocol_doesn_t_properly_handle_aave_pool_changes/clean.sol",
            text,
        )
