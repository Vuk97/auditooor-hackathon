...
PATTERN = "erc-721-burn-without-check"
DETECTOR = ROOT / "detectors" / "wave17" / "erc_721_burn_without_check.py"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "erc_721_burn_without_check"
...
class Erc721BurnWithoutCheckTest(unittest.TestCase):
    ...
    def test_detector_compiles_and_reference_points_at_owned_fixtures(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/erc_721_burn_without_check/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/erc_721_burn_without_check/clean.sol",
            text,
        )
