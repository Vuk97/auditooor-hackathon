...
DETECTOR_ID = "bridge_proof_domain_bypass_fire6"
...
class RustBridgeProofDomainBypassFire6Tests(unittest.TestCase):
    def test_positive_fixture_fires(self) -> None:
        hits = _run_fixture(
            FIXTURES / "positive" / "bridge_proof_domain_bypass_fire6.rs"
        )
    ...
    def test_guarded_fixture_is_silent(self) -> None:
        hits = _run_fixture(
            FIXTURES
            / "negative"
            / "bridge_proof_domain_bypass_fire6_guarded.rs"
        )
