...
PATTERN = "fund-loss-arithmetic-fire21"
DETECTOR = ROOT / "detectors" / "wave17" / "fund_loss_arithmetic_fire21.py"
POSITIVE = (
    ROOT
    / "detectors"
    / "test_fixtures"
    / "positive"
    / "fund_loss_arithmetic_fire21.sol"
)
NEGATIVE = (
    ROOT
    / "detectors"
...
class FundLossArithmeticFire21Test(unittest.TestCase):
    ...
    def test_detector_and_fixture_sources_are_aligned(self) -> None:
        ...
        self.assertIn("_registerPoolWithVault(pool, liquidity);", positive_text)
        self.assertIn("_registerPoolWithFactory(pool, liquidity);", positive_text)
