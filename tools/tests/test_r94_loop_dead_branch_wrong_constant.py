...
PATTERN = "r94-loop-dead-branch-wrong-constant"
DETECTOR = ROOT / "detectors" / "wave17" / "r94_loop_dead_branch_wrong_constant.py"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "r94_loop_dead_branch_wrong_constant"
...
class R94LoopDeadBranchWrongConstantTest(unittest.TestCase):
    ...
    def test_detector_reference_and_fixture_scope_stay_aligned(self) -> None:
        ...
        self.assertIn("routeKind", detector_text)
        self.assertIn("routeKind == 2", detector_text)
        ...
        self.assertIn("uint256 routeKind;", positive_text)
        self.assertIn("routeKind = 0;", positive_text)
        self.assertIn("routeKind = 1;", positive_text)
        self.assertIn("if (routeKind == 2)", positive_text)
        self.assertNotIn("routeKind = 2;", positive_text)

        self.assertIn("uint256 routeKind;", clean_text)
        self.assertIn("routeKind = 2;", clean_text)
        self.assertIn("if (routeKind == 2)", clean_text)
