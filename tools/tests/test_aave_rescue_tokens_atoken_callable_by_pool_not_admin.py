...
PATTERN = "aave-rescue-tokens-atoken-callable-by-pool-not-admin"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "aave_rescue_tokens_atoken_callable_by_pool_not_admin"
...
class AaveRescueTokensAtokenCallableByPoolNotAdminTest(unittest.TestCase):
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/aave_rescue_tokens_atoken_callable_by_pool_not_admin/ssi-fix-051_positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/aave_rescue_tokens_atoken_callable_by_pool_not_admin/ssi-fix-051_clean.sol",
            text,
        )
