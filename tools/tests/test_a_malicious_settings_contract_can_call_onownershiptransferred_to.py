...
PATTERN = "a-malicious-settings-contract-can-call-onownershiptransferred-to"
FIXTURE_DIR = (
    ROOT
    / "detectors"
    / "fixtures"
    / "a_malicious_settings_contract_can_call_onownershiptransferred_to"
)
...
DETECTOR = (
    ...
    / "detectors"
    / "wave17"
    / "a_malicious_settings_contract_can_call_onownershiptransferred_to.py"
)
POSITIVE = FIXTURE_DIR / "ssi-fix-032_positive.sol"
CLEAN = FIXTURE_DIR / "ssi-fix-032_clean.sol"
SMOKE = FIXTURE_DIR / "ssi-fix-032_smoke.json"
...
class AMaliciousSettingsContractCanCallOnownershiptransferredToTest(unittest.TestCase):
    ...
    def test_pattern_compile_round_trip_matches_generated_detector(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            prefix=".pattern_compile_a_malicious_settings_contract_",
            dir=ROOT,
        ) as tmp:
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/a_malicious_settings_contract_can_call_onownershiptransferred_to/ssi-fix-032_positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/a_malicious_settings_contract_can_call_onownershiptransferred_to/ssi-fix-032_clean.sol",
            text,
        )
