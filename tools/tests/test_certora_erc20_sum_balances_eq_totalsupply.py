...
PATTERN = "certora-erc20-sum-balances-eq-totalsupply"
REFERENCE = ROOT / "reference" / "patterns.dsl" / f"{PATTERN}.yaml"
DETECTOR = ROOT / "detectors" / "wave17" / "certora_erc20_sum_balances_eq_totalsupply.py"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "certora_erc20_sum_balances_eq_totalsupply"
...
class CertoraErc20SumBalancesEqTotalsupplyTest(unittest.TestCase):
    ...
    def test_pattern_compile_round_trip_matches_generated_detector(self) -> None:
        ...
        with tempfile.TemporaryDirectory(
            prefix=".pattern_compile_certora_erc20_sum_balances_",
            dir=ROOT,
        ) as tmp:
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/certora_erc20_sum_balances_eq_totalsupply/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/certora_erc20_sum_balances_eq_totalsupply/clean.sol",
            text,
        )
    ...
    def test_smoke_record_captures_positive_and_clean_counts(self) -> None:
        ...
        self.assertEqual(payload["vulnerable_hits"], payload["positive_hits"])
