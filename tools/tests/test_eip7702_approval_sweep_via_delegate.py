...
PATTERN = "eip7702-approval-sweep-via-delegate"
FIXTURE_DIR = ROOT / "detectors" / "fixtures" / "eip7702_approval_sweep_via_delegate"
...
class Eip7702ApprovalSweepViaDelegateTest(unittest.TestCase):
    ...
    def test_reference_yaml_points_at_owned_fixture_pair(self) -> None:
        ...
        self.assertIn(
            "vuln: detectors/fixtures/eip7702_approval_sweep_via_delegate/positive.sol",
            text,
        )
        self.assertIn(
            "clean: detectors/fixtures/eip7702_approval_sweep_via_delegate/clean.sol",
            text,
        )
