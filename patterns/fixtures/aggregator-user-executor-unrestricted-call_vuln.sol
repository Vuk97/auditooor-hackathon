...
contract AggregatorRouterVuln {
    ...
    // VULN: executor + executeParams chosen by caller, no allowlist
...
interface IERC20Ext { function balanceOf(address) external view returns (uint256); }
