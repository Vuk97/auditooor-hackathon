...
// Fixture: vulnerable — constructor does not add address(this) to ignoredForTotalSupply.
...
contract ESynth {
    ...
    // VULNERABLE: address(this) not added to ignoredForTotalSupply
    constructor(address owner_) {
        owner = owner_;
        // Missing: ignoredForTotalSupply.add(address(this));
    }
